...
export default function Dashboard() {
    ...
    const [newTotalBudgetInput, setNewTotalBudgetInput] = useState("");
    ...
    const handleAddNew = async () => {
        if (!newProjectYear || !newProjectNameInput || !newTotalBudgetInput) return;
        ...
        try {
            const response = await fetch("http://localhost:5000/budget/create", {
                ...
                body: JSON.stringify({
                    ...
                    project_name: newProjectNameInput,
                    total_budget: parseFloat(newTotalBudgetInput),
                }),
            });
            ...
            <div className="overflow-x-auto w-full max-w-4xl">
                <table className="w-full bg-white shadow-md rounded-lg overflow-hidden">
                    <thead className="bg-blue-500 text-white">
                        <tr>
                            <th className="py-2 px-4 text-left">ปีงบประมาณ</th>
