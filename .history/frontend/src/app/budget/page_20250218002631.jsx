                    ...
                    <table className="w-full bg-white shadow-md rounded-lg overflow-hidden">
                        <thead className="bg-blue-500 text-white">
                            <tr>
                                ...
                                <th className="py-2 px-4 text-left">Remaining Budget</th> {/* New Column */}
                                <th className="py-2 px-4 text-center">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            {budgets.map((budget) => {
                                const remainingBudget = budget.total_budget - (budget.amount_spent || 0); // Assuming amount_spent exists
                                ...
                                return (
                                    <tr key={budget.id} className="border-b">
                                        ...
                                        <td className="py-2 px-4">
                                            {remainingBudget} {/* Display Remaining Budget */}
                                        </td>
