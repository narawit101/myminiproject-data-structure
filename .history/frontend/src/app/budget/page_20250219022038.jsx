                  ...
                  <tr key={index} className="border-t hover:bg-gray-50">
                    ...
                    <td className="py-2 px-4">
                      {isNaN(Number(allocation.allocated_amount))
                        ? "-"
                        : Number(allocation.allocated_amount).toLocaleString()} {/* ใช้ toLocaleString เพื่อแสดงคอมม่า */}
                    </td>
                    <td className="py-2 px-4">
                      <input
                        type="number"
                    ...
                    <td className="py-2 px-4">
                      {isNaN(Number(allocation.amount_per_person))
                        ? "-"
                        : Number(allocation.amount_per_person).toLocaleString()} {/* ใช้ toLocaleString เพื่อแสดงคอมม่า */}
                    </td>
                    <td className="py-2 px-4">
                      <button
