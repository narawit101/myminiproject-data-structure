          ...
          <table className="w-full border-collapse border border-gray-300 bg-white shadow-lg rounded-lg">
            <thead>
              <tr className="bg-blue-500 text-white text-left">
                <th className="border p-4">งบประมาณทั้งหมด</th>
                <th className="border p-4">งบประมาณคงเหลือ</th>
                ...
                <th className="border p-4">จำนวนที่ได้รับ</th>
            ...
            <tbody>
              {reportData.groups.map((group, index) => (
                <tr key={index} className="border-b hover:bg-gray-50 transition duration-200">
                  ...
                  <td className="p-4">{group.allocated_amount.toFixed(2)}</td>
                  <td className="p-4">{group.remaining_budget.toFixed(2)}</td>
