  ...
  const openEditModal = (citizen) => {
    setEditData({
      ...
      birth_date: citizen.birth_date
        ? citizen.birth_date.split("T")[0]
        : "", // แปลงวันเกิดให้เป็น YYYY-MM-DD
    });
    setIsEditing(true);
  };
                ...
                <form onSubmit={handleUpdate}>
                  ...
                  <label className="block mb-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditData({ ...editData, income: e.target.value })
                      }
                      className="w-full border p-2"
                    />
                  </label>
                  ...
                  <label className="block mb-2">
                    ...
                    <input
                      type="text"
                      value={editData.target_group || "ไม่มีข้อมูล"}
                      disabled
                  ...
                  <label className="block mb-2">
                    ...
                    <input
                      type="text"
                      value={
                        editData.distribution_date
                          ? new Date(editData.distribution_date).toLocaleDateString(
                              "th-TH"
                            )
                          : "ไม่มีข้อมูล"
                      }
