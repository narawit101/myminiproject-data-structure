...
export default function CitizensPage() {
  ...
  const fetchCitizens = async () => {
    try {
      const res = await axios.get("http://localhost:5000/citizens/get");
  ...
  const handleUpdate = async () => {
    try {
      await axios.put(`http://localhost:5000/citizens/update/${form.national_id}`, form);
      fetchCitizens();
      setEditCitizen(null);
    } catch (error) {
  ...
  const handleDelete = async (national_id) => {
    ...
    try {
      await axios.delete(`http://localhost:5000/citizens/delete/${national_id}`);
      fetchCitizens();
    } catch (error) {
