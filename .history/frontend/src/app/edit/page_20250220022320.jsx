...
export default function CitizensPage() {
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    console.log("Updating citizen:", editData);
    try {
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl w-96">
              ...
              <form onSubmit={handleUpdate}>
                <input
                  ...
                  placeholder="ชื่อ"
                />
                <button type="submit" className="bg-green-600 text-white px-6 py-2 rounded-md mt-4">
                  บันทึก
                </button>
                <button onClick={() => setIsEditing(false)} className="bg-gray-600 text-white px-6 py-2 rounded-md ml-2">
                  ยกเลิก
                </button>
              </form>
            </div>
