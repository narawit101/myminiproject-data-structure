          ...
          <table className="w-full border-collapse border border-gray-300">
            <thead>
              <tr className="bg-gray-200">
                <th className="border p-2">ID</th><th className="border p-2">ชื่อ</th><th className="border p-2">นามสกุล</th><th className="border p-2">อาชีพ</th><th className="border p-2">รายได้</th><th className="border p-2">กลุ่มเป้าหมาย</th><th className="border p-2">วันแจกเงิน</th><th className="border p-2">จัดการ</th>
              </tr>
            </thead>
            <tbody>
              {citizens.map((citizen) => (
                <tr key={citizen.citizen_id} className="border">
                  ...
                  <td className="border p-2">{citizen.distribution_date}</td> {/* ข้อมูลใหม่ */}
                ...
                <form onSubmit={handleUpdate}>
                  ...
                  <label className="block mb-2">
                    ...
                    <input
                      ...
                      onChange={(e) => setEditData({ ...editData, distribution_date: e.target.value })}
                      className="w-full border p-2"
                    />
                  </label>
