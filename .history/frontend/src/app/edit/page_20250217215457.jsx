        ...
        <table className="w-full border-collapse border border-gray-300">
          <thead>
            <tr className="bg-gray-200">
              ...
              <th className="border p-2">กลุ่มเป้าหมาย</th> {/* Add this column */}
          ...
          <tbody>
            {citizens.map((citizen) => (
              <tr key={citizen.citizen_id} className="border">
                ...
                <td className="border p-2">{citizen.target_group}</td> {/* Display target group */}
          ...
          <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center">
            <div className="bg-white p-6 rounded shadow-lg w-96">
              ...
              <form onSubmit={handleUpdate}>
                ...
                <label className="block mb-2">
                  กลุ่มเป้าหมาย: {/* Add Target Group field */}
                  <input
                    type="text"
