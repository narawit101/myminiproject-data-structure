            ...
            <div className="bg-white p-6 rounded shadow-lg w-96">
              ...
              <form onSubmit={handleUpdate}>
                <label className="block mb-2">
                  ...
                  <input
                    type="text"
                    value={editData.fname || ""} // ใช้ "" แทน null
                ...
                <label className="block mb-2">
                  ...
                  <input
                    type="text"
                    value={editData.lname || ""} // ใช้ "" แทน null
                ...
                <label className="block mb-2">
                  ...
                  <input
                    type="text"
                    value={editData.occupation || ""} // ใช้ "" แทน null
                ...
                <label className="block mb-2">
                  ...
                  <input
                    type="number"
                    value={editData.income || ""} // ใช้ "" แทน null
                ...
                <label className="block mb-2">
                  ...
                  <input
                    type="date"
                    value={editData.birth_date || ""} // ใช้ "" แทน null
                ...
                <label className="block mb-2">
                  ...
                  <input
                    type="text"
                    value={editData.target_group || ""} // ใช้ "" แทน null
                    disabled
                ...
                <label className="block mb-2">
                  ...
                  <input
                    type="text"
                    value={editData.distribution_date || ""} // ใช้ "" แทน null
                    disabled
                    className="w-full border p-2 bg-gray-200"
                  />
                </label>
