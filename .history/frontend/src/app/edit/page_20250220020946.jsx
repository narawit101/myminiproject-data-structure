...
export default function CitizensPage() {
  ...
  {citizens.map((citizen, index) => (
    <tr key={`${citizen.citizen_id}-${index}`} className="border-b hover:bg-gray-50">
      ...
      <td className="border p-3 flex gap-2">
        <button onClick={() => openEditModal(citizen)} className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition duration-300">
          แก้ไข
        </button>
        <button onClick={() => handleDelete(citizen.citizen_id)} className="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 transition duration-300">
          ลบ
        </button>
      </td>
    </tr>
