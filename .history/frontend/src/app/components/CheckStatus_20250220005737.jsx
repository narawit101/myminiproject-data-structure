      ...
      <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
        ...
        {result && (
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <p>
              <strong>กลุ่มเป้าหมาย:</strong> {result.target_group || "ไม่เข้าข่าย"}
            </p>
          ...
          {result.amount && Number(result.amount) > 0 ? (
            <div className="mt-4 p-4 bg-white border border-green-500 rounded">
              <p className="text-green-600">
                <strong>จำนวนเงิน:</strong> {Number(result.amount).toLocaleString()} บาท
              </p>
              <p>
                <strong>วันที่ลงทะเบียน:</strong> {formatDate(result.transaction_date)}
              </p>
              <p>
            ...
            <p className="mt-4 text-red-500">❌ ท่านไม่ได้รับเงิน</p>
          )}
        </div>
