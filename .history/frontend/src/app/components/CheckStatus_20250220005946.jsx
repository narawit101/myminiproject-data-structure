        ...
        {result && (
          <div className="mt-6 p-6 bg-green-100 border border-green-400 rounded-lg">
            <div className="grid grid-cols-2 gap-6">
              ...
              <p className="col-span-2 space-y-2">
                <strong>วันรับเงิน:</strong> {result.distribution_date}
              </p>
            </div>

            {result.amount && Number(result.amount) > 0 ? (
              <div className="mt-6 p-6 bg-white border border-green-500 rounded-lg space-y-2">
              ...
              <p className="mt-6 text-red-500 text-lg">❌ ท่านไม่ได้รับเงิน</p>
            )}
          </div>
        )}
      </div>
