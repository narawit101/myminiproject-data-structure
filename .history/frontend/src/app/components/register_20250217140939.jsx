  ...
  return (
    <div>
      ...
      <form onSubmit={onSubmit}>
        ...
        <div><input type="number" name="national_id" placeholder="เลขบัตรประชาชน" value={formData.national_id} maxLength={13} onChange={onChange} required /></div>
        <div>
          <input type="date" name="birth_date" value={formData.birth_date} onChange={onChange} required />
        </div>
        <div>
          <input type="text" value={age} placeholder="อายุ" readOnly />
        </div>
