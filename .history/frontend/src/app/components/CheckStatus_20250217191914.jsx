...
export default function CheckTargetPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-10 p-6">
      <h1 className="text-2xl font-bold mb-5">ตรวจสอบกลุ่มเป้าหมายและวันรับเงิน</h1>
