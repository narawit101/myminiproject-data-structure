    ...
    <ProtectedRoute>
      ...
      <div className="p-6 bg-gray-100 min-h-screen">
        ...
        <div className="mb-4 flex justify-between">
          <div>
            <label className="mr-2 text-gray-700 font-medium">กรองตามสถานะ:</label>
            <select
          ...
          <div>
            <label className="mr-2 text-gray-700 font-medium">กรองตามกลุ่มเป้าหมาย:</label>
            <select
              className="border border-gray-300 rounded-md px-3 py-1 shadow bg-white"
              value={filterGroup}
                  ...
                  <tr key={index} className="border-b hover:bg-gray-50 transition duration-200">
                    ...
                    <td className="p-4 text-center">
                      <button
                        ...
                        onClick={() =>
                          handleStatusChange(item.transaction_id, item.citizen_id, item.status === "completed" ? "pending" : "completed", item.target_group_id)
                        }
                      >
                        เปลี่ยนสถานะ
                      </button>
