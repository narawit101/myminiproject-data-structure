...
export default function BudgetAllocation() {
  ...
  <input
    type="number"
    className="w-full p-2 border rounded-md text-right focus:outline-none focus:ring-2 focus:ring-blue-400"
    value={
    ...
    onChange={(e) =>
      handleEdit(
        ...
        index,
        "max_recipients",
        e.target.value.replace(/,/g, "") // ลบ , ออกจากค่าที่รับเข้า
      )
    }
  />
</td>
<td className="py-2 px-4 text-right">
  {isNaN(Number(allocation.max_recipients))
    ? "-"
