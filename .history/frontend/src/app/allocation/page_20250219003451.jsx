...
export default function BudgetAllocation() {
  ...
  const handleSave = (budgetId, index) => {
    const targetGroup = allocations[budgetId]?.allocations[index];
    
    // ตรวจสอบว่า target_group_id มีค่าหรือไม่
    if (!targetGroup?.target_group_id) {
    ...
    const updatedData = {
      ...
      target_group_id: targetGroup.target_group_id, // ใช้ target_group_id จากข้อมูลเดิม
