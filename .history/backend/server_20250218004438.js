...
const allocationRoutes = require("./routes/allocation"); // Import admin routes
...
app.use('/admin', adminRoutes); // ตั้งค่าเส้นทาง /admin
app.use('/allocation', allocationRoutes); // ตั้งค่าเส้นทาง /admin
