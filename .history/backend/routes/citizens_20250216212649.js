...
router.post('/', async (req, res) => {
    try {
        const { fname, lname, national_id,age, birth_date, income, occupation, target_group_id } = req.body;
        const newCitizen = await pool.query(
            `INSERT INTO citizens (fname, lname, national_id,age, birth_date, income, occupation, target_group_id)
             VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *`,
            [fname, lname, national_id,age, birth_date, income, occupation, target_group_id]
        );
