...
if (groupQuery.rowCount > 0) {
    ...
    console.log(📌 กลุ่มที่ตรงกับ age & income: target_group_id = ${target_group_id});
}

// ✅ 2️⃣ ถ้า target_group_id ยังเป็น null และอาชีพเป็น "เกษตรกร"
if (!target_group_id && occupation.includes("เกษตรกร")) {
    target_group_id = 3;  // 🔥 กำหนด ID 3 สำหรับเกษตรกรโดยตรง
    console.log(📌 กลุ่มที่ตรงกับอาชีพเกษตรกร: target_group_id = ${target_group_id});
}

// ✅ 3️⃣ ตรวจสอบผลลัพธ์สุดท้าย
console.log(✅ target_group_id สุดท้ายที่ใช้: ${target_group_id});
