...
app.post('/', async (req, res) => {
    try {
      ...
      const newCitizen = await pool.query(
        `INSERT INTO citizens (fname, lname, national_id, birth_date, income, occupation, target_group_id)
        VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *`,
        [fname, lname, national_id, birth_date, income, occupation, target_group_id]
      );
